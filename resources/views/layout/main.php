        ...
        <div class="hero-footer has-background-black">
            <div class="columns is-mobile">
                <div class="column has-text-left has-text-light">
                    ...
                    <a class="is-hidden-mobile" href="https://github.com/razonyang/php-opencc-demo" target="_blank" rel="noopener">
                        <?= date('Y') ?> <?= Html::encode($applicationParameters->getName()) ?>
                    </a>
                    <a class="is-hidden-desktop is-size-6" href="https://github.com/razonyang/php-opencc-demo" target="_blank" rel="noopener">
                ...
                <div class="column has-text-right has-text-light">
                    <span class="icon">
                        <a href="https://github.com/razonyang/php-opencc" target="_blank" rel="noopener">
